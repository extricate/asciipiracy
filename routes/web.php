...
// travel
    ...
    Route::post('/map/travel', 'MapController@travel')->name('travel');

    Route::get('/map/travel/{tile}', 'MapController@travelTo')->name('travel_to');
    Route::get('/map/greet/{tile}', 'MapController@greetShip')->name('greet_ship');
